...
def oval_traj_test():
    robot_interface = RobotInterface(starting_state=State(mode=Mode.MOVING, gait=Gait.TROT, frequency=1.95), trajectory_method=TrajectoryMethod.OVAL)
