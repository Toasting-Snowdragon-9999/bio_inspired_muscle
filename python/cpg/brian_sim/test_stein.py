"""@brief Run and plot the Brian2 Stein phase-oscillator CPG simulation, mapping outputs to hip-joint activations."""
...
def main():
    """@brief Run the Stein phase-oscillator CPG, plot per-neuron activations, save the figure, and print analysis.
